...
const Calender = () => {
	...
	const options= {
		...
		theme: {
			...
			text: "text-slate-900 dark:text-slate-900 hover:bg-slate-200 hover:dark:bg-slate-200",
			disabledText: "bg-white text-black dark:text-black hover:bg-slate-200 hover:dark:bg-slate-200 text-slate-400 dark:text-slate-400",
